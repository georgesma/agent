...
def get_custom_datasplits(dataset_name, test_items):
...
def main():
    for dataset_name in DATASETS_NAME:
        ...
        save_path = "out/synthesizer/custom_split_%s" % dataset_name
        synthesizer.datasplits = get_custom_datasplits(dataset_name, TEST_ITEMS)

        print("Training on %s" % dataset_name)
